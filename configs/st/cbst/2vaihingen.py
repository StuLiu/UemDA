from configs.ToVaihingen import SOURCE_DATA_CONFIG,TARGET_DATA_CONFIG, EVAL_DATA_CONFIG, TARGET_SET, \
    TEST_DATA_CONFIG, PSEUDO_DATA_CONFIG, DATASETS
MODEL = 'ResNet'
...
SNAPSHOT_DIR = './log/cbst/2vaihingen'
