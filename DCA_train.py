...
parser.add_argument('--config_path', type=str, default='st.dca.2rural',
                    help='config path')
    ...
    for i_iter in tqdm(range(cfg.NUM_STEPS_STOP)):
        if i_iter <= cfg.FIRST_STAGE_STEP:
            ...
            if i_iter < cfg.NUM_STEPS_STOP and targetloader is not None:
                ...
                loss_seg = loss_calc(pred_s1, lab_s) + loss_calc(pred_s2, lab_s)
                loss_pseudo = loss_calc(pred_t1, lab_t) + loss_calc(pred_t2, lab_t)
